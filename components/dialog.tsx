  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[97vw] max-w-md rounded border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-800 dark:bg-gray-950">
        <div className="text-lg text-zinc-900 font-semibold flex items-center gap-1 md:gap-3">
          {" "}
          <MdOutlineMail /> Enter your email to recieve updates
        </div>
        <div className="text-sm text-slate-600 font-semibold flex items-center gap-1 md:gap-3">
          Recieve price updates right in your inbox{" "}
          <CiInboxIn className="text-lg" />
        </div>
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-zinc-900 rounded-lg shadow-xs px-5 py-2 md:py-2 mt-2 w-full text-white text-base font-semibold hover:opacity-90 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-40"
          >
